...
function getContact(contact) {	
	...
	let contactData = {};
	$.ajax({
		url:"https://tannercomes.com/sc/api/call_propublica.php?name=" + contact.split(" ").join("")
		// url:"http://localhost:8888/WebUI/api/call_propublica.php?repull=true&name=" + contact.split(" ").join("")
